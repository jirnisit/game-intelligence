    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'characters',
          name: 'characters',
          component: () => import('../../features/character/pages/CharactersPage'),
        },
        {
          path: 'characters/:characterId',
          name: 'character',
          component: () => import('../../features/character/pages/CharacterPage'),
        },
        {
          path: 'teams',
          name: 'teams',
...
router.afterEach(to => {
  ...
  document.title = game ? `${game.name.en} | Kab Game` : String(to.meta.title || 'Kab Game')
})
